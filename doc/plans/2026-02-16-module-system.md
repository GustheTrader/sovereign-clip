...
- **`id`**: Unique identifier, used as the npm package name suffix (`@sovereign-clip/mod-observability`)
...
```typescript
import type { ModuleAPI } from "@sovereign-clip/core";
...
export const modulePages = [
  {
    path: "/observability",
    label: "Observability",
    component: lazy(() => import("@sovereign-clip/mod-observability/ui")),
  },
];
...
export const dashboardWidgets = [
  {
    ...
    label: "Token Burn Rate",
    placement: "dashboard",
    component: lazy(() => import("@sovereign-clip/mod-observability/ui").then(m => ({ default: m.TokenBurnRateWidget }))),
  },
];
```
  ...
  "templates": [
    {
      ...
      "url": "https://store.sovereignclip.ai/templates/startup-in-a-box.json",
      "tags": ["startup", "team"]
    }
  ]
}
...
10. **`@sovereign-clip/module-sdk`** — TypeScript types for `ModuleAPI`, `HookEvent`, `HookHandler`, manifest schema
