...
export type { TranscriptEntry, StdoutLineParser, CreateConfigValues } from "@sovereign-clip/adapter-utils";
...
export interface UIAdapterModule {
  type: string;
  label: string;
  parseStdoutLine: (line: string, ts: string) => import("@sovereign-clip/adapter-utils").TranscriptEntry[];
