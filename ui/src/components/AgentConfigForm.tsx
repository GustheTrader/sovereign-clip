...
import { AGENT_ADAPTER_TYPES } from "@sovereign-clip/shared";
import type {
  Agent,
...
// Canonical type lives in @sovereign-clip/adapter-utils; re-exported here
// so existing imports from this file keep working.
export type { CreateConfigValues } from "@sovereign-clip/adapter-utils";
