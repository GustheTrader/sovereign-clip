 ...
 *
 * Plugin bundles are built with `external: ["@sovereign-clip/plugin-sdk/ui", "react", "react-dom"]`,
 ...
 * - `import { ... } from "@sovereign-clip/plugin-sdk/ui";`
 *
...
function rewriteBareSpecifiers(source: string): string {
  ...
  const rewrites: Record<string, string> = {
    '"@sovereign-clip/plugin-sdk/ui"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@sovereign-clip/plugin-sdk/ui'": `'${getShimBlobUrl("sdk-ui")}'`,
    '"@sovereign-clip/plugin-sdk/ui/hooks"': `"${getShimBlobUrl("sdk-ui")}"`,
    "'@sovereign-clip/plugin-sdk/ui/hooks'": `'${getShimBlobUrl("sdk-ui")}'`,
 ...
 * of `@sovereign-clip/plugin-sdk/ui`, `react`, and `react-dom` resolve to the
