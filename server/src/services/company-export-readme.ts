 ...
 */
import type { CompanyPortabilityManifest } from "@sovereign-clip/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Paperclip](https://sovereignclip.ai)");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Paperclip](https://sovereignclip.ai) for more information.");
  lines.push("");

  // Footer
  lines.push("---");
  lines.push(`Exported from [Paperclip](https://sovereignclip.ai) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
