...
import { companies, pluginLogs, pluginWebhookDeliveries } from "@sovereign-clip/db";
import type {
  PluginStatus,
...
import type { ToolRunContext } from "@sovereign-clip/plugin-sdk";
import { JsonRpcCallError, PLUGIN_RPC_ERROR_CODES } from "@sovereign-clip/plugin-sdk";
...
const BUNDLED_PLUGIN_EXAMPLES: AvailablePluginExample[] = [
  {
    packageName: "@sovereign-clip/plugin-hello-world-example",
  ...
  {
    packageName: "@sovereign-clip/plugin-file-browser-example",
  ...
  {
    packageName: "@sovereign-clip/plugin-kitchen-sink-example",
