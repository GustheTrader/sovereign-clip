...
import type { PaperclipPluginManifestV1 } from "@sovereign-clip/shared";
 ...
 * import { startWorkerRpcHost } from "@sovereign-clip/plugin-sdk";
 *
 * startWorkerRpcHost({ plugin });
 * ```
 *
...
export function startWorkerRpcHost(options: WorkerRpcHostOptions): WorkerRpcHost {
  ...
  const toolHandlers = new Map<string, {
    declaration: Pick<import("@sovereign-clip/shared").PluginToolDeclaration, "displayName" | "description" | "parametersSchema">;
